...
VALUES ($1, $2, $3, $4, $5)
RETURNING id, suite_id, name, line_number, status, tags
`
...
SELECT id, suite_id, name, line_number, status, tags FROM test_cases WHERE suite_id = $1 ORDER BY line_number
`
